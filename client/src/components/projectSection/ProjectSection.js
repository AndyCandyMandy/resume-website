        ...
        <section className="projectBody" id="projectId" ref={projectRef}> 
            ...
            <div className={`projectContent hiddenElement ${projectInView ? "fadeIn" : ""}`} style={{ animationDelay: "0.2s" }}>
                <div className="projectTextBox"> 
                    <h3 className="projectContentHeader">WizCat Adventures</h3> 
                    <p className="projectContentRole">Game Developer, Design Lead, and Artist</p>
                    <p className="projectContentDesc"> 
            ...
            <div className={`projectContent hiddenElement ${projectInView ? "fadeIn" : ""}`} style={{ animationDelay: "0.4s" }}>
                <div className="projectTextBox">
                    <h3 className="projectContentHeader">Warp Trials Research Program</h3> 
                    <p className="projectContentRole">Software Developer</p>
                    <p className="projectContentDesc"> 
            ...
            <div className={`projectContent hiddenElement ${projectInView ? "fadeIn" : ""}`} style={{ animationDelay: "0.6s" }}>
                <div className="projectTextBox">
                    <h3 className="projectContentHeader">Resturant Maintainable Website</h3> 
                    <p className="projectContentRole">Fullstack Developer</p>
                    <p className="projectContentDesc"> 
